...
US_births_1994_2003 %>%
  ...
  geom_line(aes(colour = lubridate::wday(date, label = TRUE)))
```
...
The power of the tidyverse comes from being able to easily combine functions that do one thing well: you solve complex problems by stringing together simple pieces.
